    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-6">{t('createAccount')}</h2>

          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Role Selection — most important step */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">{t('selectWorkRole')}</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t('yearsExp')}</label>
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            {t('haveAccount')} <Link to="/login" className="text-blue-600 font-semibold hover:underline">{t('loginLink')}</Link>
          </p>
        </div>
      </div>
    </div>
